/**
 * @generated SignedSource<<2f19401d8a19f4aa1009feb1327fd0f5>>
...
export type PostList_root$data = {
  readonly posts: {
  ...
  readonly " $fragmentType": "PostList_root";
};
export type PostList_root = PostList_root$data;
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__PostList_root_posts_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
